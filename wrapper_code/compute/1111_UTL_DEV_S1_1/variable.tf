...
variable "enable_volume_e" {
  description = "Attach additional EBS volume E"
  type        = bool
  default     = false
}

variable "volume_e_size" {
  description = "Size of volume E in GB"
  type        = number
  default     = 0
}

variable "volume_e_type" {
  description = "Type of volume E"
  type        = string
  default     = ""
}

variable "volume_e_device_name" {
  description = "Device name for volume E"
  type        = string
  default     = ""
}
